...
@RestController
@RequestMapping("")
public class AutoTestController extends APIJSONController<Long> {
    private static final String TAG = "AutoTestController";
