...
public class CommentView extends BaseView<CommentItem> implements View.OnClickListener {
	...
	public View createView() {
		ivCommentHead = findViewWithClick(R.id.ivCommentHead, this);

		tvCommentName = findViewWithClick(R.id.tvCommentName, this);
	...
	public void bindView(CommentItem data){
		...
		ImageUtil.loadImage(ivCommentHead, data.getUser().getHead(), ImageUtil.TYPE_OVAL);
