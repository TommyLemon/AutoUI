...
import zuo.biao.library.util.ImageUtil;
...
, OnHttpResponseListener, OnDialogButtonClickListener, OnItemClickListener {
	...
	public View createView() {
		...
		ivMomentViewHead = findViewWithClick(R.id.ivMomentViewHead, this);

		tvMomentViewName = findViewWithClick(R.id.tvMomentViewName, this);
		tvMomentViewStatus = findViewWithClick(R.id.tvMomentViewStatus, this);

		tvMomentViewContent = findViewWithClick(R.id.tvMomentViewContent, this);

		gvMomentView = findViewById(R.id.gvMomentView);

		tvMomentViewDate = findViewById(R.id.tvMomentViewDate);
		ivMomentViewPraise = findViewWithClick(R.id.ivMomentViewPraise, this);
		ivMomentViewComment = findViewWithClick(R.id.ivMomentViewComment, this);

		llMomentViewPraise = findViewWithClick(R.id.llMomentViewPraise, this);
		tvMomentViewPraise = findViewWithClick(R.id.tvMomentViewPraise, this);
	...
	public void bindView(MomentItem data_){
		...
		ImageUtil.loadImage(ivMomentViewHead, user.getHead());
	...
	@Override
	public void onHttpResponse(int requestCode, String result, Throwable e) {
		if (data == null) {
