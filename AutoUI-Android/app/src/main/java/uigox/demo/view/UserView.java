...
public class UserView extends BaseView<User> {
	...
	public View createView() {
		ivUserViewHead = findViewWithClick(R.id.ivUserViewHead, this);

		tvUserViewSex = findViewWithClick(R.id.tvUserViewSex, this);

		tvUserViewName = findViewWithClick(R.id.tvUserViewName, this);
		tvUserViewId = findViewById(R.id.tvUserViewId);
		tvUserViewTag = findViewWithClick(R.id.tvUserViewTag, this);
	...
	public void bindView(User data){
		...
		ImageUtil.loadImage(ivUserViewHead, data.getHead(), ImageUtil.TYPE_OVAL);
