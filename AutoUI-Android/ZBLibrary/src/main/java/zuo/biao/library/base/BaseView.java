 ...
 */
public abstract class BaseView<T> extends RecyclerView.ViewHolder implements View.OnTouchListener, View.OnClickListener, View.OnLongClickListener {
	...
	public View.OnTouchListener onTouchListener;//接触View回调监听回调的实例
	protected List<View> onTouchViewList;
	/**设置接触View事件监听回调
	 * @param listener
	 */
	public BaseView<T> setOnTouchListener(View.OnTouchListener listener) {
		onTouchListener = listener == null ? this : listener;
		if (onTouchViewList != null) {
			for (View v : onTouchViewList) {
				if (v != null) {
	...
	public View.OnClickListener onClickListener;//点击View回调监听回调的实例
	protected List<View> onClickViewList;
	/**设置点击View事件监听回调
	 * @param listener
	 */
	public BaseView<T> setOnClickListener(View.OnClickListener listener) {
		onClickListener = listener == null ? this : listener;
	...
	public View.OnLongClickListener onLongClickListener;//长按View回调监听回调的实例
	protected List<View> onLongClickViewList;
	/**设置长按View事件监听回调
	 * @param listener
	 */
	public BaseView<T> setOnLongClickListener(View.OnLongClickListener listener) {
		onLongClickListener = listener == null ? this : listener;
		if (onLongClickViewList != null) {
			for (View v : onLongClickViewList) {
				if (v != null) {
	...
	/**通过id查找并获取控件，并setOnTouchListener
	 * @param id
	 * @param listener
	 * @return
	 */
	public <V extends View> V findView(int id, View.OnTouchListener listener) {
		return findViewWithTouch(id, listener);
	}
	/**通过id查找并获取控件，并setOnTouchListener
	 * @param id
	 * @param listener
	 * @return
	 */
	public <V extends View> V findViewWithTouch(int id, View.OnTouchListener listener) {
		V v = findViewById(id);
		v.setOnTouchListener(listener);
		if (onTouchViewList == null) {
			onTouchViewList = new ArrayList<>();
		}

		onTouchViewList.add(v);
		return v;
	}
	...
	public <V extends View> V findView(int id, View.OnClickListener listener) {
		return findViewWithClick(id, listener);
	}
	/**通过id查找并获取控件，并setOnClickListener
	 * @param id
	 * @param listener
	 * @return
	 */
	public <V extends View> V findViewWithClick(int id, View.OnClickListener listener) {
		V v = findViewById(id);
	...
	/**通过id查找并获取控件，并setOnLongClickListener
	 * @param id
	 * @param listener
	 * @return
	 */
	public <V extends View> V findView(int id, View.OnLongClickListener listener) {
		return findViewWithLongClick(id, listener);
	}
	/**通过id查找并获取控件，并setOnLongClickListener
	 * @param id
	 * @param listener
	 * @return
	 */
	public <V extends View> V findViewWithLongClick(int id, View.OnLongClickListener listener) {
		V v = findViewById(id);
		v.setOnLongClickListener(listener);
		if (onLongClickViewList == null) {
			onLongClickViewList = new ArrayList<>();
		}

		onLongClickViewList.add(v);
		return v;
	}
	...
	public void onDestroy() {
		...
		onTouchViewList = null;
		onClickViewList = null;
		onLongClickViewList = null;
