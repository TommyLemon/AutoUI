...
//		this.context = (Activity) ctx;
		...
		super.setOnDismissListener(new OnDismissListener() {
			...
			public void onDismiss(DialogInterface dialog) {
				...
				UIAutoApp.getInstance().onUIAutoDialogDismiss(AppCompatDialog.this);
			}
		});
	}
    ...
    public AppCompatDialog(@NonNull Context context, @StyleRes int theme) {
        super(context, theme);
        init(context);
    }

    protected AppCompatDialog(@NonNull Context context, boolean cancelable, OnCancelListener cancelListener) {
